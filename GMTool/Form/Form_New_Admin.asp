...
<script>
	$(function($){
		...
		$('#txtID').blur(function(){
			...
			if (this_id.length > 3){
				$.ajax({  
					url: '/Common/class/GMTool/GMT_Admin.class.asp?key=IDCK&S_item='+escape(this_id),  
					cache: false,  
...
<form id="Player_form" method="post" action="/Common/class/GMTool/GMT_Admin.class.asp?key=NEW" >
