...
<%
  ...
  SQL = SQL & " from "
	SQL = SQL & " magirita.HenchCountLog as a "
	SQL = SQL & " left join mekrita.HenchCountLog as b on a.monster_type = b.monster_type "
	SQL = SQL & " left join herseba.HenchCountLog as c on a.monster_type = c.monster_type "
	SQL = SQL & " left join prmai.HenchCountLog as d on a.monster_type = d.monster_type	"
  SQL = SQL & " where "
